...
- リポジトリの `Secrets` に ACR への接続情報を保存します。  
  ACR の [アクセス キー] より `ユーザー名` と `password` をコピーします。

  <img src="../images/P2-02-05.png" width="700">
- リポジトリの [Settings] -> [Secrets] -> [Actions] と辿り、`New repository secret` ボタンをクリックし `Secret` を追加します。  
  <img src="../images/P2-02-04.png" width="700"><br><br>

    i.  `CONTAINER_REGISTRY_USERNAME` を追加し、上でコピーした ACR の `ユーザー名` を保存します。<br>
    <img src="../images/P2-02-06.png" width="700"><br>
    ii. 同様に `CONTAINER_REGISTRY_PASSWORD` を追加し、上でコピーした ACR の `password` を設定します。<br>
