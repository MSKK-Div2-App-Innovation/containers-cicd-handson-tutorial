...
1. 以下テンプレート使用して演習 ２ 用の Azure リソースを作成します。<br>  
    ...
    > 1. 演習 1 で手動で作ったリソースを、[Bicep](https://raw.githubusercontent.com/horihiro/containers-cicd-handson-tutorial/json_template/main.json) ファイルで構成し、IaC の手法を用いることで、インフラリソースをコードとして管理・構築・再現することができます。  
