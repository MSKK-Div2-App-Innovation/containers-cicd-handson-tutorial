...
- **演習 2**
  ...
  1. **API アプリ**  
     演習 1 で作成した **API アプリのレポジトリ**に対して、以下の演習を実施し、GitHub Actions を使用したアプリケーションのデプロイワークフローを作成 
  ...
  1. **UI アプリ**  
     演習 1 で作成した **UI アプリのレポジトリ**に対して、以下の演習を実施し、GitHub Actions を使用したアプリケーションのデプロイワークフローを作成 
